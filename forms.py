...
class Mensaje(FlaskForm):
    de = TextField('De *', validators = [InputRequired(message='Indique el usuario')])
    para = TextField('Para *', validators = [InputRequired(message='Indique el Destinatario')])
    asunto = TextField('Asunto *', validators = [InputRequired(message='Indique el Asunto')])
    mensaje = TextField('Mensaje *', validators = [InputRequired(message='Indique el Mensaje')])
